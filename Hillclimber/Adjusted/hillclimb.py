...
def hillclimb(init_function,move_operator,objective_function,max_evaluations):
    ...
    init_function: function used to create the initial solution
    move_operator: function used to iterate over all possible moves for a
                    given solution (e.g. reversed_sections)
    objective_function: used to assign a numerical score to a solution
                        describing how "good" it is
    max_evaluations: limit to how many searches are performed

    TODO:
    could be adjusted to make a simulated annealing hill climber
    '''
    best = init_function()
...
def hillclimb_and_restart(init_function,move_operator,objective_function,max_evaluations):
    ...
    while num_evaluations < max_evaluations:
        ...
        evaluated, score, found = hillclimb(init_function, move_operator,
                                        objective_function, remaining_evaluations)
