...
# Adjust the TODO's to fit needs
# and run this code in the command line: python tsp.py "coordinates textfile"
#
# source: http://www.psychicorigami.com/2007/05/12/tackling-the-travelling-salesman-problem-hill-climbing/
...
def init_random_tour(tour_length):
    '''
    initialisation function that returns a random solution
    for a travelling salesman problem

    TODO:
    for our problem this should be adjusted to be a random path from
    genome of D. melanogaster to genome of D. miranda (I guess)
    '''
...
def main():
    ...
    # TODO: define
    out_file_name=None # "outfile.png"
    max_iterations=1000
    verbose=None
